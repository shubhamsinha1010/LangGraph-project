"""Root conftest.py — shared fixtures auto-discovered by pytest across all test modules."""
...
from incident_commander.services.memory_store import reset_store
...
def clean_memory_store() -> None:
    """Reset long-term memory store before every test for isolation."""
    reset_store()
